...
public class AIBomber extends AI {
    ...
    public AIBomber(GameBoard gameBoard, Bomber bomber) {
    ...
    public void calcDangerDistance() {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (map[u][v] == '1' || map[u][v] == '2' || map[u][v] == '3' || map[u][v] == '4' || map[u][v] == '5' || map[u][v] == '6' || map[u][v] == '7' || map[u][v] == '#' || map[u][v] == '*')
                    continue;
    ...
    private int[][] bfs() {
        ...
        for (int i = 0; i < m; i++)
            for (int j = 0; j < n; j++)
                if (map[i][j] == '2' || map[i][j] == '3' || map[i][j] == '4' || map[i][j] == '5' || map[i][j] == '6')
                    countSmart++;
