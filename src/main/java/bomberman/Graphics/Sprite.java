...
public class Sprite {
	...
	/**
	 * DEFAULT_size: mac dinh do rong cua anh. SIZE: do rong cua anh . x,y : toa do
	 * hien tai cua character trong tam anh chung cua tat ca thuc the. pixels: tap
	 * hop tat ca cac phan cua hinh anh thanh mot hinh anh hoan chinh .
	 * currentWidth,currentHeight: chieu rong, cao cua anh sheet: tam anh hoan
	 * chinh.
	 */
	...
	public static Sprite bomb_exploded_horizontal_left_last1 = new Sprite(DEFAULT_SIZE, 0, 8, 16, 16,
			SpriteSheet.tiles);
	public static Sprite bomb_exploded_horizontal_left_last2 = new Sprite(DEFAULT_SIZE, 0, 9, 16, 16,
			SpriteSheet.tiles);

	public static Sprite ebomb_exploded_horizontal_right_last = new Sprite(DEFAULT_SIZE, 2, 7, 16, 16,
			SpriteSheet.tiles);
	public static Sprite bomb_exploded_horizontal_right_last1 = new Sprite(DEFAULT_SIZE, 2, 8, 16, 16,
			SpriteSheet.tiles);
	public static Sprite bomb_exploded_horizontal_right_last2 = new Sprite(DEFAULT_SIZE, 2, 9, 16, 16,
			SpriteSheet.tiles);
	...
	/**
	 * Tinh khoang thoi gian chuyen dong cua moi thuc the va tra ve thuc the can
	 * render tai thoi diem do
	 * 
	 * @param normal
	 * @param x1
	 * @param x2
	 * @param animate: luu lai so chuyen dong
	 * @param time:    thoi gian di chuyen
	 * @return
	 */
	public static Sprite movingSprite(Sprite normal, Sprite x1, Sprite x2, int animate, int time) {
		int calc = animate % time;
		int timeOfSprite = time / 3;

		if (calc < timeOfSprite) {
			return normal;
		}
		if (calc < timeOfSprite) {
			return x1;
